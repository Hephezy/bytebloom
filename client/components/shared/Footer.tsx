    ...
    <footer className="border-t border-border bg-background py-12 mt-20">
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          {/* Brand */}
          <div>
            <h3 className="text-lg font-bold text-foreground mb-2">Byte Bloom</h3>
            <p className="text-sm text-muted-foreground">
              A modern blogging platform built with Next.js, GraphQL, and Prisma for creators who want to share their stories.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="https://github.com/hephezy" className="text-sm text-muted-foreground hover:text-foreground transition-colors">
                  GitHub
                </a>
              </li>
              <li>
        ...
        <div className="border-t border-border pt-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            {/* Copyright */}
            <p className="text-sm text-muted-foreground">
              &copy; {currentYear} Byte Bloom. All rights reserved.
            </p>
            ...
            <div className="flex gap-4">
              ...
              <a href="https://github.com/hephezy" target="_blank" className="text-muted-foreground hover:text-foreground transition-colors">
